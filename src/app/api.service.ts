...
export class ApiService {
  ...
  viewCompliant=(dataToSend:any)=>
  {
    return this.http.post("http://localhost:8081/viewMyCompliant",dataToSend)
  }

  viewAllCompliant=()=>
  {
    return this.http.get("http://localhost:8081/viewAllCompliant")
  }
}
